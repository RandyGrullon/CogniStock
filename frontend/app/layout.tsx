          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-[#0a0a0a]/50 backdrop-blur-md">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-xs font-mono text-zinc-400">NY Time: 09:30:45</span>
              </div>
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-3 pl-4 border-l border-white/10">
                  <div className="text-right hidden sm:block">
                    <p className="text-xs font-medium text-white">AI Portfolio #1</p>
                    <p className="text-[10px] text-zinc-500 font-mono">$104,320.50</p>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-zinc-700 to-zinc-900 border border-white/10" />
                </div>
              </div>
            </header>
